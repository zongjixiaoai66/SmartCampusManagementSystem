    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="kechengId" name="kechengId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="成绩" prop="chengjiChengji">
                       <el-input v-model="ruleForm.chengjiChengji"
                                 placeholder="成绩" clearable  :readonly="ro.chengjiChengji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="成绩" prop="chengjiChengji">
                           <el-input v-model="ruleForm.chengjiChengji"
